  ...
  return (
    <main className="min-h-screen bg-gradient-to-br from-background via-muted/20 to-background p-4 flex items-center justify-center">
      <div className="w-full max-w-3xl mx-auto space-y-10">
        {/* Back Navigation */}
        <div className="pt-4">
          <Link href="/" className="inline-flex items-center gap-2 text-[var(--electric-blue)] hover:text-[var(--electric-blue)]/80 transition-colors font-medium">
        ...
        <div className="text-center py-8">
          <div className="mb-6">
            <div className="inline-flex items-center gap-3 bg-card/60 backdrop-blur-sm rounded-full px-6 py-3 border border-border shadow">
              <div className="w-8 h-8 bg-[var(--electric-blue)] rounded-lg flex items-center justify-center">
                <TrendingUp className="w-5 h-5 text-white" />
              </div>
              <span className="text-sm font-semibold text-[var(--electric-blue)]">AI-Powered Analysis</span>
            </div>
          </div>
        ...
        {/* Form Card */}
        <Card className="w-full bg-card/80 backdrop-blur-sm border-0 shadow-xl shadow-[var(--electric-blue)]/10 rounded-2xl">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                <div className="space-y-3">
                  ...
                  <Input
                    ...
                    required
                    className="w-full h-12 border-2 border-border focus:border-[var(--electric-blue)] focus:ring-2 focus:ring-[var(--electric-blue)]/20 transition-all rounded-lg"
                  />
        ...
        {pdfUrl && (
          <Card className="w-full bg-card/90 backdrop-blur-sm border-0 shadow-xl shadow-green-500/10 mt-10">
              ...
              <CardTitle className="flex items-center justify-between text-2xl">
                ...
                <div className="flex gap-2">
                  <Button
                    ...
                    className="flex items-center gap-2 bg-card/20 hover:bg-card/30 text-white border-white/30"
                  >
            ...
            <CardContent className="p-8">
              <div className="w-full h-96 md:h-[600px] border-2 border-border rounded-lg overflow-hidden shadow-inner bg-muted">
                <iframe
                  src={pdfUrl}
